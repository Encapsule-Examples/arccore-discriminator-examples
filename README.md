...
cdr @ holarchy ~/code/encapsule/dmr-hello-world (master)
└─ $ ▶ node index.js
================================================================
DMR request #0:
This is FILTER #1 that accepts only a string value and always returns a string value.
...
DMR request #2:
request: '{"function1":{"value":{}}}'
response: '{"error":"Filter [vS1Z9-UcLWXa0p2-v4coew::Discriminator Filter] failed while performing main operation. Filter [nZ1U9MixT0SFxB8CrlmP8w::FILTER #1] failed while normalizing request input. Error at path '~.function1.value': Value of type 'jsObject' not in allowed type set [jsString]."}'
================================================================
================================================================
DMR request #3:
request: '{"function2":{"value":"Ah, no."}}'
response: '{"error":"Filter [vS1Z9-UcLWXa0p2-v4coew::Discriminator Filter] failed while performing main operation. Filter [0KgMnqEeQYi5fsyDkRmjyw::FILTER #2] failed while normalizing request input. Error at path '~.function2.value': Value of type 'jsString' not in allowed type set [jsNumber]."}'
================================================================
================================================================
DMR request #4:
request: '"going... nowhere..."'
response: '{"error":"Filter [vS1Z9-UcLWXa0p2-v4coew::Discriminator Filter] failed while performing main operation. Unrecognized request format. Request signature must match one of filter set {[0KgMnqEeQYi5fsyDkRmjyw::FILTER #2], [nZ1U9MixT0SFxB8CrlmP8w::FILTER #1]}."}'
================================================================
================================================================
DMR request #5:
This is FILTER #1 that accepts only a string value and always returns a string value.
...
This is FILTER #1 that accepts only a string value and always returns a string value.
request: '{"function1":{"value":"TRIGGER-ERROR"}}'
response: '{"error":"Filter [vS1Z9-UcLWXa0p2-v4coew::Discriminator Filter] failed while performing main operation. Filter [nZ1U9MixT0SFxB8CrlmP8w::FILTER #1] failed while performing main operation. AN ERROR HAS OCCURRED INSIDE YOUR BODY FUNCTION!"}'
================================================================
================================================================
DMR request #7:
This is FILTER #1 that accepts only a string value and always returns a string value.
request: '{"function1":{"value":"TRIGGER-BUG"}}'
response: '{"error":"Filter [vS1Z9-UcLWXa0p2-v4coew::Discriminator Filter] failed while performing main operation. Filter [nZ1U9MixT0SFxB8CrlmP8w::FILTER #1] failed while normalizing response result. Error at path '~': Value of type 'jsObject' not in allowed type set [jsString]."}'
================================================================
Thank you for playing DMR! And, happy hacking :)
```
